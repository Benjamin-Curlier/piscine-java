package piscine.moulinette.cli;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Point d'entrée CLI de la moulinette Piscine Java.
 *
 * <h2>Usage</h2>
 * <pre>
 *   # Via Maven exec plugin (développement)
 *   mvn -f moulinette/pom.xml -pl cli exec:java \
 *       -Dexec.mainClass="piscine.moulinette.cli.Main" \
...
public class Main {
    ...
    private static void printHelp() {
        System.out.println("""
                Moulinette Piscine Java v0.1.0-SNAPSHOT
