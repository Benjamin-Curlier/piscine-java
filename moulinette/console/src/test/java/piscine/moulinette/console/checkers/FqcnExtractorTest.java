...
class FqcnExtractorTest {
    ...
    void extrait_fqcn_avec_package(@TempDir Path dir) throws IOException {
        ...
        Files.writeString(f, "package piscine.m1;\n\nclass HelloWorldTest {}\n");
        assertThat(FqcnExtractor.fqcn(f)).isEqualTo("piscine.m1.HelloWorldTest");
    }
    ...
    void liste_les_fqcn_dun_repertoire(@TempDir Path dir) throws IOException {
        Path pkg = dir.resolve("src/piscine/m1");
        Files.createDirectories(pkg);
        Files.writeString(pkg.resolve("ATest.java"), "package piscine.m1;\nclass ATest {}\n");
        Files.writeString(pkg.resolve("BTest.java"), "package piscine.m1;\nclass BTest {}\n");
        assertThat(FqcnExtractor.fqcnsUnder(dir.resolve("src")))
            .containsExactlyInAnyOrder("piscine.m1.ATest", "piscine.m1.BTest");
    }
}
