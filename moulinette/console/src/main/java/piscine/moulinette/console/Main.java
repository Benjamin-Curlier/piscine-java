...
import piscine.moulinette.console.repl.Repl;
import piscine.moulinette.console.repl.ReplIo;
...
import piscine.moulinette.console.workspace.Workspace;
...
public final class Main {
    ...
    private static void printUsage() {
        System.out.println("""
            Moulinette Piscine Java — console locale
