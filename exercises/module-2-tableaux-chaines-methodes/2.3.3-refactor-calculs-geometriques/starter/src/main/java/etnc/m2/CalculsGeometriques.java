...
/**
 * Exercice 2.3.3 — Calculs geometriques (refactor en methodes static).
 *
 * Completez les quatre methodes surchargees. Une version a un parametre
 * (rayon) concerne le cercle ; une version a deux parametres concerne le
 * rectangle. Testees par valeur de retour.
 */
public class CalculsGeometriques {

    /** Aire d'un cercle de rayon donne. */
    public static double aire(double rayon) {
        // TODO : Math.PI * rayon * rayon
        return 0.0;
    }

    /** Aire d'un rectangle de largeur et hauteur donnees. */
    public static double aire(double largeur, double hauteur) {
        // TODO : largeur * hauteur
        return 0.0;
    }

    /** Perimetre d'un cercle de rayon donne. */
    public static double perimetre(double rayon) {
        // TODO : 2 * Math.PI * rayon
        return 0.0;
    }
