...
/**
 * Exception métier signalant qu'un effectif affecté à une unité est invalide.
 *
 ...
 *       pour permettre le <strong>chaînage</strong> de la cause (cf. {@code Unite.affecter(String)}).</li>
 * </ul>
 */
