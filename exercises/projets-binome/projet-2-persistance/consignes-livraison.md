# Consignes de livraison — Projet binôme #2

## Modalités

- Ce projet se réalise **en binôme**. Les binômes sont **imposés par les
  formateurs**.
- Durée indicative : environ 14 heures, réparties sur plusieurs séances.
...
- **Où se trouve le fichier de données** `taches.csv` : son chemin et son
  encodage (UTF-8).
