...
- **#21 — Module 5** (7 chapitres, 10 exercices, 3 sous-groupes) → débloque le **Projet binôme #2**. **Brief de démarrage prêt** : [`superpowers/2026-06-04-m5-kickoff.md`](superpowers/2026-06-04-m5-kickoff.md) (PR #41) = point d'entrée de la prochaine session.
