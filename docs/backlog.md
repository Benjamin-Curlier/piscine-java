...
- **#19 — Module 3 (POO)** (10 chapitres, 14 exercices, 4 sous-groupes) → débloque le **Projet binôme #1**. **PROCHAIN CHANTIER.** Brief de démarrage : [`superpowers/2026-06-03-m3-kickoff.md`](superpowers/2026-06-03-m3-kickoff.md).
