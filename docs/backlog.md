...
- **#18 — Module 2** (5 chapitres, 12 exercices, 4 sous-groupes) — **en cours**. Brief : [`docs/superpowers/2026-06-01-m2-kickoff.md`](superpowers/2026-06-01-m2-kickoff.md). Validation désormais **locale** (Java 25 + Maven installés) en plus du CI.
  - ✅ **Volet chapitres livré** (branche `feature/m2-chapitres`) : `_category_.json` + 5 chapitres (2.1 Tableaux 1D, 2.2 Tableaux 2D, 2.3 Chaînes, 2.4 Méthodes, 2.5 Récursivité) + liaison module 1→2. Build Docusaurus vert. Spec [`specs/2026-06-01-m2-chapitres-design.md`](superpowers/specs/2026-06-01-m2-chapitres-design.md), plan [`plans/2026-06-01-m2-chapitres.md`](superpowers/plans/2026-06-01-m2-chapitres.md). *(lien PR à compléter au merge)*
  - ⬜ **Volets exercices** (cycles séparés, 1 sous-groupe = 1 PR) : 2.1 Tableaux, 2.2 Chaînes, 2.3 Méthodes, 2.4 Récursivité. Décisions transverses figées (spec §10) : tout dans `main` pour 2.1/2.2, récursivité imposée par consigne, refactor 2.3.3 basé sur 1.2.2.
