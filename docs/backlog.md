...
- **#19 — Module 3 (POO)** (10 chapitres, 14 exercices, 4 sous-groupes) → débloque le **Projet binôme #1**. **EN COURS.** Brief : [`superpowers/2026-06-03-m3-kickoff.md`](superpowers/2026-06-03-m3-kickoff.md) ; conception : spec [`specs/2026-06-03-m3-chapitres-design.md`](superpowers/specs/2026-06-03-m3-chapitres-design.md) + plan [`plans/2026-06-03-m3-chapitres.md`](superpowers/plans/2026-06-03-m3-chapitres.md).
    - **Volet chapitres** (2 PR de 5) :
        - 🔄 **PR-A — 3-1 à 3-5** (bases & héritage) : `classes-et-objets`, `encapsulation`, `constructeurs`, `this-et-static`, `heritage` + `_category_.json` + liaison module 2→3. Build Docusaurus vert.
        - ⬜ **PR-B — 3-6 à 3-10** (abstraction & types modernes) : `polymorphisme`, `classes-abstraites`, `interfaces`, `enums`, `records-et-sealed`.
