...
- **#18 — Module 2** (5 chapitres, 12 exercices, 4 sous-groupes) — **en cours**. Brief : [`docs/superpowers/2026-06-01-m2-kickoff.md`](superpowers/2026-06-01-m2-kickoff.md). Validation désormais **locale** (Java 25 + Maven installés) en plus du CI.
  ...
  - 🟡 **Volet exercices** (cycles séparés, 1 sous-groupe = 1 PR) : 2.1 Tableaux, 2.2 Chaînes, 2.3 Méthodes, 2.4 Récursivité. **Brief de démarrage prêt** : [`superpowers/2026-06-01-m2-exos-kickoff.md`](superpowers/2026-06-01-m2-exos-kickoff.md). Décisions transverses figées (spec chapitres §10) : tout dans `main` pour 2.1/2.2, méthodes `static` testées par retour pour 2.3/2.4, récursivité imposée par consigne, refactor 2.3.3 basé sur 1.2.2.
    ...
    - ✅ **2.2 Chaînes** : `palindrome`, `comptage-occurrences`, `ascii-art`. Saisie clavier + test sur sortie ; solutions validées en local (`valider-solutions` + lint 0 erreur). Spec [`specs/2026-06-02-m2-exos-2-2-design.md`](superpowers/specs/2026-06-02-m2-exos-2-2-design.md).
